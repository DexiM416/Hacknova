    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden py-20">
      ...
      <div className="container mx-auto px-4 lg:px-8 xl:px-12 text-center relative z-10">
        ...
        <motion.h1
          ...
          className="font-space text-fluid-h1 font-bold tracking-tight mb-4"
        >
          <motion.span
          ...
          <span className="relative inline-block min-w-[4ch]">
            <AnimatePresence mode="wait">
              {!showNova ? (
                ...
                <motion.span
                  key="nova"
                  className="text-accent text-glow-gold inline-block"
        ...
        <motion.h2
          ...
          className="font-space text-3xl md:text-5xl lg:text-6xl font-bold text-primary text-glow-cyan mb-8"
        >
          HACKATHON 2026
        </motion.h2>
        ...
        <motion.div
          ...
          whileHover={{ scale: 1.05 }}
        >
          <div className="inline-flex items-center gap-4 px-10 py-5 rounded-2xl bg-accent/10 border border-accent/30 box-glow-gold animate-float hover:bg-accent/15 transition-all duration-300 cursor-default">
            <Trophy className="w-10 h-10 text-accent" />
            <div className="text-left">
              <p className="text-xs md:text-sm text-accent/70 font-medium uppercase tracking-widest">Total Prize Pool</p>
              <p className="font-space text-4xl md:text-5xl lg:text-6xl font-bold text-accent text-glow-gold">₹60,000</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <p className="text-sm md:text-base text-muted-foreground">Registration closes Feb 21, 2026</p>
        </motion.div>
